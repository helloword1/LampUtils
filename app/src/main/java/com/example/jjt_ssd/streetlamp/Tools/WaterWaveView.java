...
/**
 * Created by JJT-ssd on 2016/9/18.
 */
...
/**
 * 水波效果*/
class WaterWaveView extends ImageView {
    ...
    private void init() {
        setWaveInfo(60f, 1.5f, 10f, 60f, Color.argb(230,0,164,131));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        clipPath.addRoundRect(new RectF(0, 0, width, height), 190.0f, 190.0f, Path.Direction.CW);
